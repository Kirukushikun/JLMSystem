...
return [
    ...
    'notifications' => [
        'notifications' => [
            // Mail notifications disabled for now: Mailtrap sandbox rate-limits emails
            // and was masking successful backups as failures. Re-enable once a real
            // mail provider (or a higher Mailtrap plan) is in place.
